...
This outlines how to propose a change to hello. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("wolfmissotten/hello", fork = TRUE)`.
...
of
Conduct](https://wolfmissotten.github.io/Repo_package_hello/CODE_OF_CONDUCT.md).
